...
dc = TsDataCache(data_path=r"C:\ts_data", refresh=True, sdt='2000-01-02', edt='2023-07-20')


# 在浏览器中查看单标的单级别的分型、笔识别结果
bars = dc.pro_bar(ts_code='600160.SH', asset='E', start_date='20190306', end_date="20230720", freq='D')
c = CZSC(bars)
c.open_in_browser()
